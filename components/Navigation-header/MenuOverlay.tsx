...
export default function MenuOverlay({
  ...
  return (
    ...
    ${isAdminPage ? "pl-0 lg:pl-9 " : "pl-0 "} bg-secondary`}
        ...
        exit="exit"
      >
        <div className="absolute top-0 right-0 p-1 w-full flex justify-between space-x-1">
        ...
        "
          ...
          <motion.h1 className="" variants={sectionVariants}>
            <Link
        ...
        <div className=" px-1 mt-[20vh] lg:mt-[20vh] h-full w-full flex flex-col lg:flex-row ">
          ...
          >
            <div className="grid w-full    text-xs  px-3">
              <Input
                className="bg-secondary border-b-background placeholder:text-background placeholder:text-lg lg:placeholder:text-xl font-serif-display text-background text-lg lg:text-xl h-9 py-2 lg:mb-6 w-full"
                id="text"
                type="text"
                placeholder="Search..."
              />
