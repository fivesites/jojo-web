...
export default function FloatingNav() {
  ...
  return (
    <>
      <div className="fixed bottom-0 right-0 left-0   z-30 pb-9 pr-9 pl-9  w-full flex justify-end lg:justify-start   items-start ">
        <motion.div
          variants={headerVariants}
          initial="hidden"
          animate="visible"
          className="flex  items-start justify-between bg-background w-auto    space-x-1 p-1  border-secondary border-l-6 border-b border-r border-t rounded-none lg:w-auto "
        >
