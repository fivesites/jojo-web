...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2  text-sm cursor-pointer  whitespace-nowrap rounded-none    transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        ...
        sm: "h-6 px-1 pb-0.5 text-sm  tracking-wide   flex flex-col items-start justify-start ",
